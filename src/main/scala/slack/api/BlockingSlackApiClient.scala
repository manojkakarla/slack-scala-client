...
class BlockingSlackApiClient(token: String, duration: FiniteDuration = 5.seconds) {
  ...
  def getChannelReplies(channelId: String, thread_ts: String)(implicit ec: ExecutionContext): RepliesChunk = {
  ...
  def postChatMessage(channelId: String, text: String, username: Option[String] = None, asUser: Option[Boolean] = None,
                      ...
                      deleteOriginal: Option[Boolean] = None, threadTs: Option[String] = None)(implicit ec: ExecutionContext): String = {
    resolve(client.postChatMessage(channelId, text, username, asUser, parse, linkNames, attachments, blocks,
